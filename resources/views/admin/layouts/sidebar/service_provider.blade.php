<ul id="side-menu-baer">
    ...
    <li class="{{ request()->routeIs('profile.profile-picture') ? 'menuitem-active' : '' }}">
        <a href="{{ route('profile.profile-picture') }}" class="{{ request()->routeIs('profile.profile-picture') ? 'active' : '' }}">
    ...
    <li class="{{ request()->routeIs('profile.business-info') ? 'menuitem-active' : '' }}">
        <a href="{{ route('profile.business-info') }}" class="{{ request()->routeIs('profile.business-info') ? 'active' : '' }}">
